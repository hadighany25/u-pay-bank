...
const userSchema = new mongoose.Schema(
  {
    ...
    // 🔥 បន្ថែមថ្មី៖ ការតាមដានប្រតិបត្តិការប្រកបដោយភាពអនាមិក (Suspicious Activity Tracking)
...
// 🔥 បន្ថែម Index ត្រូវដាក់នៅ "ពីលើ" ការបង្កើត Model
userSchema.index({ username: 1 });
userSchema.index({ accountNumber: 1 });
userSchema.index({ accountNumberKHR: 1 });
userSchema.index({ "transactions.refId": 1 }); // ជួយអោយការឆែកប្រវត្តិលុយលឿនជាងមុន

// បន្ទាប់មកទើបយើងប្រកាស Model យកទៅប្រើប្រាស់
const User = mongoose.model("User", userSchema);

// ===================================
// ប្រព័ន្ធ Chat Schema
// ===================================
const ChatSchema = new mongoose.Schema({
  ...
  timestamp: Number,
  isRead: Boolean,
  deletedBy: { type: Array, default: [] }, // 🔥 បន្ថែមថ្មី (ជម្រើសលុបសារ)
});
